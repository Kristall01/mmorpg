...
export default class SpectreRenderer extends EntityRenderer {
	...
	drawTo(ctx: RenderContext, direction: Direction, pos: Position, opectre: EntityLike, size: number, activityTime: number, activity: SpectreActivity, translate: [number,number] | "center" = "center") {
